 ...
 * @var string[]|\Cake\Collection\CollectionInterface $houses
 */
?>
<!--Header-->
	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $reservation->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
    ...
    <div class="card-body text-body-secondary">
            ...
            <fieldset>
                <legend><?= __('Edit Reservation') ?></legend>
                    ...
                    <?php echo $this->Form->control('students_id', ['options' => $students]); ?>
                    <?php echo $this->Form->control('houses_id', ['options' => $houses]); ?>
                    ...
                    <?php echo $this->Form->control('studentcard'); ?>
                    <?php echo $this->Form->control('studentcard_dir'); ?>
