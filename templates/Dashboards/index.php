...
<div class="horizontal-tabs border-bottom my-4">
	...
	<?= $this->Html->link(__('Contacts'), ['controller' => 'Contacts', 'action' => 'add', 'prefix' => false], ['class' => 'topMenu', 'escape' => false]) ?>
	<?= $this->Html->link(__('FAQ'), [ 'controller' => 'Faqs', 'action' => 'index', 'prefix' => false], ['class' => 'topMenu', 'escape' => false]) ?>
</div>
...
<div class="row">
	<div class="col-md-9 border-end">
		<style>
			...
			.img-one {
  				grid-area: 1 / 1 / 3 / 5; /* now spans 2 rows and 3 columns */
			}
			...
			.image-container img {
				width: 100%;  /* match profile photo width */
    			height: 100%;
				border-radius: 10px;
				object-fit: cover;
			}
		...
		<div class="d-none d-sm-block">
			<div class="activity-container">
				<div class="image-container img-one">
					<?= $this->Html->image('header/banner.jpg', ['alt' => 'NRHUB']); ?>
					<div class="overlay">
						<h3><a href="" class="stretched-link header" target="_blank"><b>NR Hub</b></a></h3>
					</div>
				</div>
				<div class="image-container img-two">
					<?= $this->Html->image('header/ucs.jpg', ['alt' => 'JPNR']); ?>
					<div class="overlay">
						<h3><a href="https://selangor.uitm.edu.my/index.php/ms/component/sppagebuilder/?view=page&id=119" class="stretched-link header" target="_blank"><b>JPNR</b></a></h3>
					</div>
				</div>
				<div class="image-container img-three">
					<?= $this->Html->image('header/hep.jpg', ['alt' => 'BHEP']); ?>
					<div class="overlay">
						<h3><a href="https://selangor.uitm.edu.my/index.php/ms/component/sppagebuilder/?view=page&id=119" class="stretched-link header" target="_blank"><b>HEP</b></a></h3>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row px-2 mb-4">
			<div class="col-md-3 border rounded-start pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_student; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Registered Students
			</div>
			<div class="col-md-3 border pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_house; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total House Registered
			</div>
			<div class="col-md-3 border pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_reservation; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Housed Reservations
			</div>
			<div class="col-md-3 border pt-3 pb-3 bg-body-tertiary">
